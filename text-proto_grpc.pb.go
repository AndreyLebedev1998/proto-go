...
const (
	TextService_SendText_FullMethodName = "/example.TextService/SendText"
)
...
type TextServiceClient interface {
	SendText(ctx context.Context, in *TextMessage, opts ...grpc.CallOption) (*TextMessage, error)
}
...
func (c *textServiceClient) SendText(ctx context.Context, in *TextMessage, opts ...grpc.CallOption) (*TextMessage, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TextMessage)
	err := c.cc.Invoke(ctx, TextService_SendText_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TextServiceServer interface {
	SendText(context.Context, *TextMessage) (*TextMessage, error)
...
func (UnimplementedTextServiceServer) SendText(context.Context, *TextMessage) (*TextMessage, error) {
...
func _TextService_SendText_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TextMessage)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TextServiceServer).SendText(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TextService_SendText_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TextServiceServer).SendText(ctx, req.(*TextMessage))
	}
...
var TextService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "example.TextService",
	HandlerType: (*TextServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SendText",
			Handler:    _TextService_SendText_Handler,
		},
	},
